...
import requests
import datetime
from serviceNow import getIncidents
app = dash.Dash('ServiceNow-data')
...
data_dict= {"Open Tickets":deque(maxlen=max_length)}
...
def update_graph(data_names,input_data):
    graphs = []
    print(getIncidents())
    ...
    for data_name in data_names:
        ...
        graphs.append(html.Div(dcc.Graph(
            id=data_name,
            animate=True,
            figure={'data': [data],'layout' : go.Layout(xaxis=dict(range=[start,end]),
